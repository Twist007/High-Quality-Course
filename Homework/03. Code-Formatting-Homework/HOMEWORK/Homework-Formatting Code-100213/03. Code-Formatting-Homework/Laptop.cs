...
namespace Problem2_LaptopShop
{
    class Laptop
    {
        ...
        public string Processor { get { return this.processor; }
            set
            {
                if (value.Count() < 2)
                {
        ...
        public string RAM { get {return this.ram; }
            set
            {
                if (value.Count() < 3)
                {
        ...
        public string GraphicsCard { get { return this.graphicsCard; }
            set
            {
                if (value.Count() < 2)
                {
        ...
        public string HDD { get { return this.hdd; }
            set
            {
                if (value.Count() < 2)
                {
        ...
        public string Screen { get {return this.screen; }
            set
            {
                if (value.Count() < 2)
                {
        ...
        public Battery BatteryType { get {return this.batteryType; }
            set
            {
