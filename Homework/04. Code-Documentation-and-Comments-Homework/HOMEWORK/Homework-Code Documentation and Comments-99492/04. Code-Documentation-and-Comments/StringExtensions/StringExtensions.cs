namespace StringExtensions
{
    ...
    /// <summary>
    /// Extensions for string class in .NET.
    /// </summary>
    public static class StringExtensions
    {
        /// <summary>
        /// Hash string using MD5, then convert it to Unicode.
        /// </summary>
        ...
        /// <summary>
        /// Check if string is predefined boolean value.
        /// </summary>
        ...
        /// <summary>
        /// Try to convert given string to short.
        /// </summary>
        /// <param name="input">String to be converted</param>
        /// <returns>Short value of given string or 0</returns>
        ...
        /// <summary>
        /// Try to convert given string to integer.
        /// </summary>
        /// <param name="input">String to be converted</param>
        /// <returns>Integer value of given string or 0</returns>
        ...
        /// <summary>
        /// Try to convert given string to long.
        /// </summary>
        /// <param name="input">String to be converted</param>
        /// <returns>Long value of given string or 0</returns>
        ...
        /// <summary>
        /// Try to convert given string to DateTime
        /// </summary>
        /// <param name="input">String to be converted</param>
        /// <returns>DateTime of given string or 0</returns>
        ...
        /// <returns>Capitalized first letter plus unchanged rest of string or empty string</returns>
